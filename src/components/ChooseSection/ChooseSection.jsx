  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why choose IITU university ?</h2>
                ...
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            IITU is the only university in Kazakhstan that received institutional international accreditation ASIIN in 2019 and passed the procedure of official confirmation of compliance with international standards.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            In December 2019, according to the rating of the National Chamber of Entrepreneurs “Atameken”, MUIT entered the TOP-3 universities in Kazakhstan, as well as first place in such educational programs as “information systems” and “electronic journalism”.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            Almaty is one of the largest and most beautiful cities in Kazakhstan. The city is the cultural and historical center of Kazakhstan. Almaty is the economic and financial center of Kazakhstan. Many major companies' offices, banks and financial institutions are located here, promoting economic growth and development.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
